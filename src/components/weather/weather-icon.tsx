  ...
  return (
    ...
    >
      <Icon
        className={cn(
          SIZE_CLASSES[size],
          getIconColor(code, isDay),
          animated && getAnimationClass(code)
        )}
...
function getAnimationClass(code: WeatherCode): string {
  // Sunny - gentle pulse
  if ([0, 1].includes(code)) {
    return 'animate-pulse';
  }
  // Rain / Drizzle - subtle bounce
...
// Larger decorative weather icon for hero sections
