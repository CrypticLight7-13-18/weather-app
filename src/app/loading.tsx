      ...
      <header className="sticky top-0 z-40 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-700/50 px-4 py-3">
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-slate-200 dark:bg-slate-700 skeleton-shimmer" />
            <div className="hidden sm:block space-y-1">
              <div className="h-5 w-20 bg-slate-200 dark:bg-slate-700 rounded skeleton-shimmer" />
              <div className="h-3 w-16 bg-slate-200 dark:bg-slate-700 rounded skeleton-shimmer" />
            </div>
          </div>
          <div className="flex-1 max-w-md h-10 bg-slate-200 dark:bg-slate-700 rounded-xl skeleton-shimmer" />
          <div className="flex gap-2">
            <div className="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-700 skeleton-shimmer" />
            <div className="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-700 skeleton-shimmer" />
          </div>
        </div>
      </header>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-5 border border-slate-200 dark:border-slate-700">
              ...
              <div className="space-y-3">
                {Array.from({ length: 3 }).map((_, i) => (
                  <div key={i} className="h-16 bg-slate-200 dark:bg-slate-700 rounded-xl skeleton-shimmer" />
                ))}
              </div>
            </div>
